...
![ATC learning-rate response and beta2 heatmap](recipe_sweep_packed4_atc_20m_128k/tuning.png)

[PDF](recipe_sweep_packed4_atc_20m_128k/tuning.pdf) ·
[PNG](recipe_sweep_packed4_atc_20m_128k/tuning.png).
...
- [Per-run CSV](recipe_sweep_packed4_atc_20m_128k/runs.csv): losses, seeds, job IDs, and artifact locations.
- [Summary CSV](recipe_sweep_packed4_atc_20m_128k/summary.csv): all 24 configurations ranked by mean loss.
- [Results and provenance](recipe_sweep_packed4_atc_20m_128k/results.json): full metrics, hashes, and AWC comparisons.
- [Slurm accounting](recipe_sweep_packed4_atc_20m_128k/slurm-accounting.txt).
- [Plot script](recipe_sweep_packed4_atc_20m_128k/plot.py).
...
```bash
uv run python doc/recipe_sweep_packed4_atc_20m_128k/plot.py
```
