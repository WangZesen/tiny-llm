...
[summary CSV](recipe_sweep_packed4_20m_128k/summary.csv).
...
![Fixed-LR beta1 response and complete beta1/beta2 heatmap](recipe_sweep_packed4_20m_128k/betas.png)
...
recipe.
[PDF](recipe_sweep_packed4_20m_128k/betas.pdf) · [PNG](recipe_sweep_packed4_20m_128k/betas.png).
...
[PDF](recipe_sweep_packed4_20m_128k/tuning.pdf) · [PNG](recipe_sweep_packed4_20m_128k/tuning.png).
...
- [Per-run CSV](recipe_sweep_packed4_20m_128k/runs.csv): all 129 seeded records and artifact locations.
- [Summary CSV](recipe_sweep_packed4_20m_128k/summary.csv): all 43 ranked configurations.
- [Results and provenance](recipe_sweep_packed4_20m_128k/results.json): full metrics, source metadata, input hashes, and accounting.
- [Plot script](recipe_sweep_packed4_20m_128k/plot.py): regenerates both PDF/PNG figure pairs from the summary CSV.
