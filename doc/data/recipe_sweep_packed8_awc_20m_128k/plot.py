"""Regenerate eight-worker AWC heatmaps and LR response figures."""
...
def main():
    ...
    fig.suptitle(
        "AWC · eight 20M workers · 131,072 targets per batch\n"
    ...
    fig.suptitle(
        "AWC · eight 20M workers · learning-rate response\n"
