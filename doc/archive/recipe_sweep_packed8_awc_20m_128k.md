---
title: "AWC packed-8 20M tuning at 128K tokens per batch"
...
![Complete beta1/beta2 heatmaps at all five learning rates](../data/recipe_sweep_packed8_awc_20m_128k/heatmaps.png)

[PDF](../data/recipe_sweep_packed8_awc_20m_128k/heatmaps.pdf) ·
[PNG](../data/recipe_sweep_packed8_awc_20m_128k/heatmaps.png).
...
![Learning-rate response for all four beta1 values](../data/recipe_sweep_packed8_awc_20m_128k/tuning.png)

[PDF](../data/recipe_sweep_packed8_awc_20m_128k/tuning.pdf) ·
[PNG](../data/recipe_sweep_packed8_awc_20m_128k/tuning.png).
...
[summary CSV](../data/recipe_sweep_packed8_awc_20m_128k/summary.csv).
...
[matched comparison CSV](../data/recipe_sweep_packed8_awc_20m_128k/matched_packed4.csv)
...
- [Per-run CSV](../data/recipe_sweep_packed8_awc_20m_128k/runs.csv): all 240 measurements and artifact locations.
- [Summary CSV](../data/recipe_sweep_packed8_awc_20m_128k/summary.csv): all 80 ranked configurations.
- [Results and provenance](../data/recipe_sweep_packed8_awc_20m_128k/results.json).
- [Matched four-worker comparisons](../data/recipe_sweep_packed8_awc_20m_128k/matched_packed4.csv).
- [Slurm accounting](../data/recipe_sweep_packed8_awc_20m_128k/slurm-accounting.txt).
- [Collection script](../data/recipe_sweep_packed8_awc_20m_128k/collect.py).
- [Plot script](../data/recipe_sweep_packed8_awc_20m_128k/plot.py).
- [Report generator](../data/recipe_sweep_packed8_awc_20m_128k/write_report.py).
