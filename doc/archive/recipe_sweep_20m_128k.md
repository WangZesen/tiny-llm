---
title: "Synchronous 20M tuning at 128K tokens per batch"
...
![Learning-rate sweep with beta2 curves and seed variation](../data/recipe_sweep_20m_128k/tuning.png)
...
The star marks the selected recipe. Download the [PDF](../data/recipe_sweep_20m_128k/tuning.pdf)
or [PNG](../data/recipe_sweep_20m_128k/tuning.png).
...
- [Per-run CSV](../data/recipe_sweep_20m_128k/runs.csv): all 72 losses, seeds, job IDs,
  durations, and archive-relative run directories.
- [Summary CSV](../data/recipe_sweep_20m_128k/summary.csv): all 24 combinations, sorted
  by mean loss, with three seeds and sample SD for each.
- [Results and provenance](../data/recipe_sweep_20m_128k/results.json): audited run
  metrics, grouped results, source hashes, cache identity, and environment.
- [Plot script](../data/recipe_sweep_20m_128k/plot.py): regenerates the figure from the
...
as described in the [README](../guides/training.md#training), reproduce a seed with:
...
```bash
uv run python doc/data/recipe_sweep_20m_128k/plot.py
```
