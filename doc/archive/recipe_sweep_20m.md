---
title: "20M training-recipe benchmark"
...
|---|---:|---:|---:|---:|---|
| Synchronous | 0.0028 | 0.999 | 3.564370 | 0.003590 | [YAML](../data/recipe_sweep_20m/selected-synchronous.yaml) |
| Packed-4 | 0.0048 | 0.999 | 3.587822 | 0.006839 | [YAML](../data/recipe_sweep_20m/selected-packed-4.yaml) |
| Packed-8 | 0.0052 | 0.999 | 3.624001 | 0.011932 | [YAML](../data/recipe_sweep_20m/selected-packed-8.yaml) |
...
retained in [results.json](../data/recipe_sweep_20m/results.json) and the selected YAMLs.
...
are in the [108-row summary CSV](../data/recipe_sweep_20m/summary.csv).
...
- Full-grid heatmaps: [PDF](../data/recipe_sweep_20m/heatmaps.pdf),
  [PNG](../data/recipe_sweep_20m/heatmaps.png). The full-size files show all 12 LRs per mode.
- Winning validation curves: [PDF](../data/recipe_sweep_20m/validation-curves.pdf),
  [PNG](../data/recipe_sweep_20m/validation-curves.png),
  [curve data](../data/recipe_sweep_20m/validation_curves.csv).
- [Per-run CSV](../data/recipe_sweep_20m/runs.csv): 324 final-validation results.
- [Grouped CSV](../data/recipe_sweep_20m/summary.csv): 108 complete combinations and ranks.
- [JSON results and provenance](../data/recipe_sweep_20m/results.json): exact per-run and
  grouped values, selections, grid, seeds, revisions, environment, and job IDs.

![Winning subset-validation curves](../data/recipe_sweep_20m/validation-curves.png)
