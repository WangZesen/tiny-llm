---
title: "AWC beta2 = 0.99 analysis for packed-4 20M at 128K tokens per batch"
...
![AWC beta2 0.99 learning-rate response, beta1 sensitivity, and ATC comparison](../data/recipe_sweep_packed4_awc_beta99_20m_128k/tuning.png)

[PDF](../data/recipe_sweep_packed4_awc_beta99_20m_128k/tuning.pdf) ·
[PNG](../data/recipe_sweep_packed4_awc_beta99_20m_128k/tuning.png).
...
- [Per-run CSV](../data/recipe_sweep_packed4_awc_beta99_20m_128k/runs.csv): all 30 AWC measurements at beta2 0.99.
- [Summary CSV](../data/recipe_sweep_packed4_awc_beta99_20m_128k/summary.csv): all ten configurations.
- [Matched ATC comparison](../data/recipe_sweep_packed4_awc_beta99_20m_128k/atc-comparison.csv).
- [Results](../data/recipe_sweep_packed4_awc_beta99_20m_128k/results.json): metrics and hashes of the complete source datasets.
- [Complete AWC provenance](../data/recipe_sweep_packed4_20m_128k/results.json): input hashes, source origins, and accounting.
- [Plot script](../data/recipe_sweep_packed4_awc_beta99_20m_128k/plot.py).
...
```bash
uv run python doc/data/recipe_sweep_packed4_awc_beta99_20m_128k/plot.py
```
