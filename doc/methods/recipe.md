...
[three-seed 128K-token sweep](../results/optimizer-tuning.md). The 50M/90M presets
follow the earlier [single-seed campaign](../archive/campaign_results.md). These selections
...
validated in the [128K-token sweep](../results/optimizer-tuning.md) on GH200.
...
[GH200 measurements](../archive/gh200_performance.md).
...
[three-seed 128K-token sweep winner](../results/optimizer-tuning.md):
LR 0.008, beta1 0.95, beta2 0.99, four local models, microbatch 32 per model, and
